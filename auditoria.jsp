...
<%
    ...
    String[][] logs = {
            ...
            {"04/05/2026 13:30", "Produto", "Produto editado", "admin", "Arroz 1kg: preco 0,99EUR -> 0,89EUR", ""},
            {"04/05/2026 13:00", "Encomenda", "Encomenda confirmada", "Funcionário Teste", "Encomenda #6 — Maria Santos", "6,50 €"},
            {"04/05/2026 11:45", "Encomenda", "Encomenda cancelada", "Rui Faria", "Encomenda #5 — devolucao de saldo", "+2,49 €"},
            {"04/05/2026 10:00", "Promoção", "Promoção criada", "admin", "Promocao de Primavera — 10% desconto", ""},
            {"03/05/2026 09:00", "Utilizador", "Utilizador inativado", "admin", "Conta de Pedro Sousa desativada", ""},
            {"01/05/2026 08:00", "Carteira", "Deposito", "Joao Costa", "Carteira cliente", "+50,00 €"},
    };

    Map<String, Integer> tabCounts = new LinkedHashMap<>();
    tabCounts.put("Carteira", 0);
    tabCounts.put("Utilizador", 0);
    tabCounts.put("Produto", 0);
    tabCounts.put("Encomenda", 0);
    tabCounts.put("Promoção", 0);
    for (String[] l : logs) {
        Integer c = tabCounts.get(l[1]);
        if (c != null) tabCounts.put(l[1], c + 1);
    }
    ...
    String filterFrom = request.getParameter("de") != null ? request.getParameter("de") : "2026-01-05";
    String filterTo = request.getParameter("ate") != null ? request.getParameter("ate") : "2026-05-04";
    ...
    <main class="main-content">
        ...
        <div class="cat-tabs">
            <a href="auditoria.jsp" class="cat-tab <%= "".equals(activeTab)          ? "active":"" %>" data-filter="">
                ...
                Todos <span class="tab-badge"><%= logs.length %></span>
            </a>
        ...
        <div class="panel">
            <div class="panel-header">
                ...
                <span class="results-count" id="rowCount"><%= logs.length %> entradas</span>
            </div>
