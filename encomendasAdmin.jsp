...
<div class="app-shell">
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <a href="criarEditarEncomendaAdmin.jsp?novo=true" class="btn-nova">
                <svg viewBox="0 0 24 24" style="width:15px;height:15px;fill:currentColor;">
                    <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/>
                </svg>
                Nova encomenda para cliente
            </a>
        </div>
        ...
        <!-- FILTERS BAR -->
        <form action="encomendasAdmin.jsp" method="get">
            <div class="filters-bar">
                ...
                <div class="filter-group" style="flex:0 0 auto;min-width:180px;">
                    ...
                    <select name="estado" class="filter-select">
                        ...
                        <option value="Confirmada" <%= "Confirmada".equals(filterEstado) ? "selected" : "" %>>Confirmada</option>
                        <option value="Cancelada"  <%= "Cancelada".equals(filterEstado) ? "selected" : "" %>>Cancelada</option>
                    </select>
                </div>
                ...
                <a href="encomendasAdmin.jsp" class="btn-clear">Limpar</a>
            </div>
        </form>
...
<script>
    ...
    document.querySelector('input[name="cliente"]').addEventListener('input', function () {
        ...
        document.querySelectorAll('.orders-table tbody tr').forEach(row => {
            const name = row.querySelector('.client-cell')
                ? row.querySelector('.client-cell').textContent.toLowerCase() : '';
