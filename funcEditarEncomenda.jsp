...
<%
    ...
    Object[][] catalogue = {
            {"agua", "Água", "1.5L", 49, 0, 0},
            {"arroz", "Arroz", "1kg", 89, 10, 2},
            {"azeite", "Azeite", "750ml", 499, 0, 0},
            {"leite", "Leite", "1L", 71, 10, 1},
            {"pao", "Pão de forma", "", 129, 0, 0},
    };

    boolean isPendente = "Pendente".equalsIgnoreCase(orderStatus);
    ...
    <main class="main-content">
        ...
        <div class="order-meta">
            ...
            <%
                ...
                if ("Confirmada".equalsIgnoreCase(orderStatus)) mClass = "badge-confirmada";
                if ("Cancelada".equalsIgnoreCase(orderStatus)) mClass = "badge-cancelada";
            %>
                ...
                <div class="summary-panel">
                    ...
                    <div class="estado-row">
                        ...
                        <select id="estadoSelect" name="estado" class="estado-select">
                            <option value="Pendente"   <%= "Pendente".equalsIgnoreCase(orderStatus) ? "selected" : "" %>>
                                Pendente
                            </option>
                            <option value="Confirmada" <%= "Confirmada".equalsIgnoreCase(orderStatus) ? "selected" : "" %>>
                                Confirmada
                            </option>
                            <option value="Cancelada"  <%= "Cancelada".equalsIgnoreCase(orderStatus) ? "selected" : "" %>>
                                Cancelada
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="action-btns">
                        ...
                        <!-- Confirmar encomenda -->
                        <form id="orderForm" action="FuncEditarEncomendaServlet" method="post"
