...
<%
    ...
    String perfilNome = "Funcionário Teste";
    String perfilEmail = "funcionario@felixubershop.pt";
    String perfilTelefone = "913 000 000";

    String estado = "Ativo";
    String encomendasValidadas = "24";
    String membroDesde = "01/01/2026";
    String ultimoLogin = "04/05/2026 09:00";

    String successMsg = (String) request.getAttribute("success");
    String errorMsg = (String) request.getAttribute("error");
    if (successMsg == null && "1".equals(request.getParameter("saved")))
        successMsg = "Dados guardados com sucesso.";
        ...
        <div class="profile-row">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form action="FuncProfileServlet" method="post" autocomplete="off">
