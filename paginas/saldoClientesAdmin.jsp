...
<head>
    ...
    <title>saldoClientesAdmin</title>
    <style>
        *, *::before, *::after {
        ...
        <div class="page-grid">
            ...
            <div class="saldo-panel">
                <div class="saldo-panel-header">
                    ...
                    <span class="saldo-panel-title">Gerir saldo</span>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span class="val" id="selName"><%= selName.isEmpty() ? "—" : selName %></span>
                </div>
                <div class="info-row">
                    <span class="lbl">Saldo atual</span>
                    <span class="val-green" id="saldoAtual">
                ...
                <div class="saldo-action">
                    ...
                    <form action="saldoClientesAdmin.jsp" method="post"
                        ...
                        <button type="submit" class="btn-add">Adicionar saldo</button>
                    </form>
                </div>
                ...
                <div class="saldo-action">
                    ...
                    <form action="saldoClientesAdmin.jsp" method="post"
                        ...
                        <input type="number" name="valor" id="remValor"
                               ...
                               placeholder="0,00" required/>
                        <button type="submit" class="btn-remove">Retirar saldo</button>
                    </form>
                </div>
