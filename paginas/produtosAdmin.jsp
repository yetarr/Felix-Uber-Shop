    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if ("guardar".equals(postAction)) {
            ...
            if (nome == null || nome.isBlank() || precoStr == null || precoStr.isBlank()) {
                ...
                try {
                    ...
                    if (produtoId == null || produtoId.isBlank()) {
                        ...
                        response.sendRedirect("produtosAdmin.jsp?produtoId=" + newId);
                        return;
                    } else {
                        PreparedStatement ps = conn.prepareStatement(
                        ...
                        response.sendRedirect("produtosAdmin.jsp?produtoId=" + produtoId);
                        return;
                    }
                } catch (NumberFormatException e) {
                    errorMsg = "Preço ou stock inválido.";
                } catch (Exception e) {
            ...
            try {
                ...
                ps.setInt(1, Integer.parseInt(produtoId));
                ps.executeUpdate();
                closeAll(null, ps, conn);
            ...
            <div class="panel">
                ...
                <table class="products-table" id="productsTable">
                    ...
                    <tr class="<%= isSelected ? "selected" : "" %>"
                        ...
                        <td class="product-nome"><%= pnome %>
                        </td>
                        <td class="product-desc"><%= pdesc %>
                        </td>
                        <td><%= precoStr %>
                        </td>
                        <td><%= pstock %>
            ...
            <div class="edit-panel">
                ...
                <div id="editFormArea">
                    ...
                    <div class="photo-area" id="editPhotoUpload">
                        ...
                        <svg viewBox="0 0 24 24" id="editPhotoIcon">
                            <path d="M12 15.2A3.2 3.2 0 1 1 12 8.8a3.2 3.2 0 0 1 0 6.4zm0-8.2a5 5 0 1 0 0 10A5 5 0 0 0 12 7zM4 5h2.17L7.4 3.6A1 1 0 0 1 8.26 3h7.48a1 1 0 0 1 .86.6L17.83 5H20a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z"/>
                        </svg>
