...
<%
    ...
    String[][] history = {
        {"04/05/2026 14:32", "Pagamento encomenda #3", "Carteira cliente", "FelixUberShop",   "-1,78 €"},
        {"03/05/2026 10:00", "Depósito",               "—",               "Carteira cliente", "+20,00 €"},
        {"02/05/2026 09:55", "Pagamento encomenda #2", "Carteira cliente", "FelixUberShop",   "-5,78 €"},
        {"01/05/2026 16:00", "Levantamento",           "Carteira cliente", "—",               "-10,00 €"},
        {"01/05/2026 06:00", "Depósito",               "—",               "Carteira cliente", "+50,00 €"},
    };

    String successMsg = (String) request.getAttribute("success");
    String errorMsg   = (String) request.getAttribute("error");

    String saldoStr = String.format("%d,%02d €", saldoCents/100, saldoCents%100);
        ...
        <main class="main-content">
            ...
            <div class="wallet-top">
                ...
                <div class="wallet-card action-card">
                    ...
                    <form action="CarteiraServlet" method="post"
