...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            int userCartId = rs.next() ? rs.getInt("id_carteira") : -1;
            rs.close();
            ps.close();
            ...
            if ("adicionar".equals(acao)) {
                ...
                ps.setString(4, "Depósito na carteira");
                ps.executeUpdate();
...
<head>
    ...
    <style>
        *, *::before, *::after {
        ...
        .action-label.add-lbl {
            color: #00CE86;
        }

        .action-label.rem-lbl {
            color: #e07070;
        }
    ...
    <main class="main-content">
        ...
        <div class="wallet-top">
            ...
            <div class="wallet-card balance-card">
                ...
                <div class="balance-value" id="liveBalance"><%= saldoStr %>
                </div>
        ...
        <div class="panel">
            ...
            <div class="empty-state">
                <svg viewBox="0 0 24 24">
                    <path d="M21 7H3c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2z"/>
                </svg>
            ...
            <table class="history-table">
                ...
                <tr>
                    ...
                    <td class="value-cell <%= valClass %>"><%= hval %>
                    </td>
                </tr>
                <% } %>
                </tbody>
