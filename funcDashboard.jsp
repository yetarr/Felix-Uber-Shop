...
<%
    ...
    int encPendentes = 5;
    int encHoje = 12;
    int encHojeCanceladas = 3;
    int encHojeConfirmadas = 9;
    int clientesRegistados = 24;

    String[][] recentOrders = {
            {"8", "Ana Silva", "04/05/2026 18:10", "3,20 €", "Pendente"},
    ...
    String[][] walletFeed = {
            {"pagamento", "enc. #8", "Ana Silva", "04/05/2026 18:10", "-3,20 €"},
            {"deposito", "", "João Costa", "04/05/2026 15:00", "+20,00 €"},
            {"pagamento", "enc. #6", "Maria Santos", "04/05/2026 13:00", "-6,50 €"},
            {"devolucao", "enc. #5", "Rui Faria", "04/05/2026 11:45", "+2,49 €"},
    };
